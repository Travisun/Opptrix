...
import InnoTextarea from '../../components/inno/InnoTextarea'
    ...
    <Dialog open={open} onOpenChange={(_, data) => { if (!data.open) onClose() }}>
      <DialogSurface className={mergeClasses(s.dialogSurface, 'inno-dialog-surface')}>
        <DialogBody className={s.dialogBody}>
          ...
          <div className={mergeClasses(s.dialogScroll, 'inno-scroll')}>
          ...
          <div className={s.dialogFooter}>
            {kind === 'builtin' && builtinDetail && (
              <InnoButton variant="secondary" onClick={onCopyBuiltin}>
                <CopyRegular fontSize={14} />
                复制为自编
              </InnoButton>
            )}
            {kind === 'custom' && custom && (
              <InnoButton variant="secondary" onClick={onEditCustom}>
                编辑
              </InnoButton>
            )}
          </div>
            ...
            <div className={s.dialogForm}>
              <div className={s.formSection}>
                ...
                <div className={s.formGrid}>
                  <InnoField label="策略名称" hint="在策略库与选股页中显示">
                    <InnoInput
                      value={draft.name}
                  ...
                  <InnoField label="一句话说明" hint="简短概括策略风格，显示在列表副标题">
                    <InnoInput
                      value={draft.tagline}
              ...
              <div className={s.formSection}>
                ...
                <div className={s.formGrid}>
                  ...
                  <InnoField label="方法论" hint="可选，记录投资框架或参考体系" multiline>
                    <InnoTextarea
                      resize="vertical"
                      rows={3}
                  ...
                  <InnoField label="挖掘侧重" hint="可选，指导 Agent 深挖时的关注点" multiline>
                    <InnoTextarea
                      resize="vertical"
                      rows={2}
          ...
          <div className={s.dialogFooter}>
            {mode === 'edit' && (
              <div className={s.dialogFooterStart}>
                <InnoButton variant="secondary" onClick={onDelete}>
                  <DeleteRegular fontSize={14} />
                  删除
                </InnoButton>
              </div>
            )}
            <InnoButton variant="secondary" onClick={onClose}>
              取消
            </InnoButton>
            <InnoButton variant="primary" onClick={onSave} disabled={!canSave}>
