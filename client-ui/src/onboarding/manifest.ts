...
export const ONBOARDING_RELEASE_BY_VERSION: Record<string, OnboardingReleaseContent> = {
  ...
  '0.6.29': {
    welcomeTitle: '全球市场的投研，一句话说清楚',
    welcomeSubtitle:
      '本地 A 股资料更稳：同步与计算因子时，设置和其他功能照常可用；初选筛选与行业统计也更快更顺。',
    updateLine: '欢迎回来。你的会话、关注列表与本地数据已保留，可直接继续投研。',
    features: [
      {
        kicker: '这一版',
        title: '算因子时，界面不再卡住',
        desc:
          '本地指标在后台维护，浏览设置、查看行情、继续对话都不会被拖慢。',
        note: '同步与计算各走各的，日常操作更安心。',
      },
      {
        kicker: '替你筛选',
        title: '初选与行业统计更跟手',
        desc:
          '按因子、行业、评分等条件筛股，结果更快呈现；行业涨跌与成分股一览也更稳定。',
        note: '本地数据就绪后，离线也能做初步筛选。',
      },
      {
        kicker: '替你打理',
        title: '基础数据状态一目了然',
        desc:
          '设置里可单独查看因子与行业统计的维护进度，不必等整页转圈才知道进展。',
        note: '该同步的同步，该计算的计算，分工更清晰。',
      },
      {
        kicker: '替你查证',
        title: '问一句，得来一份完整报告',
