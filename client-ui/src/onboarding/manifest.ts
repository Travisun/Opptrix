...
export const ONBOARDING_COPY = {
  ...
  fuyao: {
    title: '启用同花顺数据源',
    desc: '连接同花顺后，可免费下载并同步全市场 A 股历史行情，供本地研究与离线查询。',
    readyLead: '同花顺数据源已就绪，可开始同步全市场历史行情。',
    readyBadge: '已启用同花顺数据源',
    readyEnabled: '数据源已启用，全市场历史行情可在本地同步与查询。',
    readyDisabled: '密钥已保存。点「继续」后将自动启用，并开始同步历史行情。',
