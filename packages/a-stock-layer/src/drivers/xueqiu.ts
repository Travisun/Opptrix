...
export class XueqiuDriver extends BaseDriver {
  private cookies = ''

  get name() { return 'xueqiu' }
  get priority() { return 10 }
  capabilities() {
    return [Capability.STOCK_REALTIME, Capability.INDEX_REALTIME, Capability.STOCK_MONEY_FLOW]
  }
