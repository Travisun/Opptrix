...
const INTENT_RULES: IntentRule[] = [
  ...
  },
  {
    ...
    confidence: 'high',
    hint: '问场外基金档案 → get_fund_profile；净值用 get_fund_nav；勿用 ETF 工具或股票概况',
  },
  {
    intent: 'otc_fund_nav',
    priority: 102,
    patterns: [
      /场外基金.*(?:净值|走势)|(?:净值|走势).*场外基金/,
      /开放式基金.*净值/,
      /货币基金.*净值/,
      /债券基金.*净值/,
    ],
  ...
  },
  {
    ...
    avoidTools: ['get_instrument_snapshot', 'get_dragon_tiger', 'get_limit_updown', 'web_search'],
    confidence: 'high',
  ...
  },
  {
    ...
    avoidTools: ['get_market_regime', 'web_search'],
    confidence: 'high',
  ...
  },
  {
    ...
    avoidTools: ['get_instrument_indicators', 'web_search'],
    confidence: 'high',
  ...
  },
  {
    ...
    avoidTools: ['evaluate_instrument', 'web_search'],
    confidence: 'high',
  ...
  },
  {
    ...
    avoidTools: ['evaluate_instrument', 'invoke_provider_custom_method', 'web_search'],
    confidence: 'high',
  ...
  },
  {
    ...
    avoidTools: ['list_news_articles', 'evaluate_instrument', 'web_search'],
    confidence: 'high',
  ...
  },
  {
    ...
    avoidTools: ['evaluate_instrument', 'get_instrument_chart', 'get_instrument_indicators', 'web_search'],
    confidence: 'high',
...
export const TOOL_CONFUSION_PAIRS: ReadonlyArray<{
  ...
  { prefer: 'get_fund_nav', avoid: 'get_instrument_quotes', when: '问场外基金净值序列' },
  { prefer: 'get_fund_nav', avoid: 'get_etf_nav', when: '问场外基金而非 ETF 净值' },
  { prefer: 'get_fund_holdings', avoid: 'get_etf_holdings', when: '问场外基金季报重仓而非 ETF 成分' },
  { prefer: 'get_fund_profile', avoid: 'get_etf_profile', when: '问场外基金档案而非 ETF 档案' },
  ...
  { prefer: 'get_instrument_notices', avoid: 'web_search', when: '标的官方公告，而非公开网页检索' },
