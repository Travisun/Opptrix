...
logger = logging.getLogger("ashare.registry")
...
class DriverRegistry:
    ...
    def discover_and_register_all(self) -> int:
        ...
        driver_modules = [
            "aaashare.drivers.eastmoney",
            "aaashare.drivers.mootdx_driver",
            "aaashare.drivers.efinance_driver",
            "aaashare.drivers.tencent",
            "aaashare.drivers.sina",
            "aaashare.drivers.tonghuashun",
            "aaashare.drivers.netease",
            "aaashare.drivers.xueqiu",
        ]
