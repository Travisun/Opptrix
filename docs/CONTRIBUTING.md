...
> ### 协作即同意（必读）
>
> **向本仓库提交 Issue、Pull Request、patch、代码、文档、设计、翻译等任何贡献，即视为你已阅读并同意** [贡献者许可协议 CLA（中文）](./CLA.md) / [CLA (English)](./CLA.en.md) **以及本文**。不同意请勿贡献。  
...
- 向本仓库贡献须遵守 **[CLA（中文）](./CLA.md)**（英文对照：[CLA.en.md](./CLA.en.md)；冲突时以中文为准）。CLA 采用「不可撤销宽许可 + 人身权协调」方案：你可保留对原创贡献的名义版权与**署名权**；财产权许可授予 Opptrix Team（含再许可与为项目需要更换/双许可的权利）；就修改权/保护作品完整权，你同意项目方为项目目的修改、演绎、整合且不据此主张侵权。
- 提交 Issue / PR 即表示同意 CLA 与本文（详见 CLA §1）。
