...
| AKShare 函数 | 数据源 | Provider | 说明 |
|---|---|---|---|
| `crypto_js_spot` | jin10 datacenter | misc-data | 加密货币实时行情 |
| `crypto_bitcoin_hold_report` | jin10 datacenter | misc-data | 比特币持仓报告 |
| `crypto_bitcoin_cme` | jin10 datacenter | misc-data | CME 比特币成交量 |
