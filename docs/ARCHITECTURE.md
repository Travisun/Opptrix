...
> **AI OS 内核愿景**（Gate / Session / Memory / Pack / Ingress 演进）：[AI-OS-KERNEL.md](./AI-OS-KERNEL.md) **v0.2**。扩展与商店：[EXTENSION-PLATFORM-ARCHITECTURE.md](./EXTENSION-PLATFORM-ARCHITECTURE.md)。
